...
export default function page() {
  ...
  return (
    <div className="bg-[#f9f9f9] min-h-screen font-sans text-[#1a1a1a] antialiased">
      
      {/* ================= PAGE HEADER ================= */}
      <div className="bg-white border-b border-gray-200 py-8 lg:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 tracking-tight">All Products</h1>
          <p className="text-sm text-gray-500 mt-2">Browse our collection of fresh, organic produce.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 bg-white border border-gray-100 rounded-2xl shadow-sm flex flex-col items-center justify-center py-32 px-4 text-center">
